...
and probably simplest to start there since the whole point is to move to stage structure

Once you move to stage structure

1. Recruits ~ rlnorm(-sigma_r^2/2,sigma_r)

2. n_t = n_t-1 * exp(-m)

3. That's it for now

Do you have length or age data? If length, then do their whole transition matrix thingy
