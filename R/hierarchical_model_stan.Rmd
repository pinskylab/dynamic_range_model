...
// time varying latent variables--need to be defined in model block
...
// define initial values of time-varying latent variables; not sure if these will vary among chains
N[1] ~ gamma((z0^2/sd0^2),(z0/sd0^2));
lambda[1] ~ gamma((z0^2/sd0^2),(z0/sd0^2));
gamma_shape[1] ~ uniform(1e3, 1e7);
gamma_rate[1] ~ uniform(1, 1000);
...
N[2:len_t] ~ gamma(gamma_shape, gamma_rate); 
