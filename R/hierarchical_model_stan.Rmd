...
N ~ gamma(p, sigma_process); // wanted a negative binomial when it was discrete... I know the math is wrong for this distribution now!
...
dataStan1 <- list(len_t=nrow(dogfishTest), 
                  ...
                  lambda0=1000, # NO IDEA IF THIS IS THE RIGHT BALLPARK!
